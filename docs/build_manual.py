...
MANUALS = [
    ...
    # ── 2. Owner ─────────────────────────────────────────────────────────────
    {
        ...
        "sections": [
            ...
            ("Communications", "Send email broadcast messages to parents by level, class, or individually.", "communications"),
    ...
    # ── 3. System Admin ───────────────────────────────────────────────────────
    {
        ...
        "sections": [
            ...
            ("System Health", "Live service status: Database (with latency), Celery worker, Email (SMTP), SMS. Auto-refreshes every 30 seconds.", "admin_health"),
        ],
    },
    # ── 4. Headteacher ────────────────────────────────────────────────────────
    {
        ...
        "sections": [
            ...
            ("Communications", "Send email messages to parents — by level, class, or individually.", "communications"),
        ],
    },
    # ── 5. Academic Teacher ────────────────────────────────────────────────────
    {
