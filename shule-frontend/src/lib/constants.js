...
export const FEATURE_ROLES = {
  ...
  // Narrower than EXAMS — mirrors exactly the roles ClassPerformanceView /
  // SubjectPerformanceView accept server-side. Excludes the legacy TEACHER
  // role, which those two endpoints reject with a 403.
