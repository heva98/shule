...
import { inputCls as baseInputCls, selectCls as baseSelectCls, textareaCls as baseTextareaCls } from '../../lib/formStyles'

const inputCls = `${baseInputCls} w-full text-right`
const fieldCls = `${baseInputCls} w-full`
const selectCls = `${baseSelectCls} w-full`
const textareaCls = `${baseTextareaCls} w-full`
